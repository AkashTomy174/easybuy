...
urlpatterns = [
    ...
    path("orders/item-cancel/<int:item_id>/",views.order_item_cancel,name="order_item_cancel"),
    ...
    path("wishlist/<int:wishlist_id>/", views.specific_wishlist_view, name="specific_wishlist"),
    ...
    path("wishlist/toggle/<int:variant_id>/<int:wishlist_id>/",views.toggle_wishlist,name="toggle_wishlist"),
    path("wishlist/toggle/<int:variant_id>/",views.toggle_wishlist,name="toggle_wishlist_default"),
    path(
