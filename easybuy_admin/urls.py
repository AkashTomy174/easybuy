...
urlpatterns = [
    ...
    path("promotions/", views.admin_promo_codes, name="admin_promo_codes"),
    path("promotions/toggle/<int:coupon_id>/", views.toggle_admin_promo_code, name="toggle_admin_promo_code"),
